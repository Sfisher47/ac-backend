...
CREATE TABLE `MaterialContributions` (
  ...
  `amount` DOUBLE(13, 2) NOT NULL DEFAULT 0,
  `user_id` int(10) unsigned NOT NULL,
  `action_id` int(10) unsigned  NULL,
  `extra_id` int(10) unsigned  NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `MaterialNeeds` (
  ...
  `title` varchar(256) NOT NULL,
  `description` varchar(400)  NULL,
  `required` DOUBLE(13, 2) NOT NULL DEFAULT 0,
  `collected` DOUBLE(13, 2) NOT NULL DEFAULT 0,
...
CREATE TABLE `MoneyNeeds` (
  ...
  `title` varchar(256) NOT NULL,
  `description` varchar(400)  NULL,
  `required` DECIMAL(13, 2) NOT NULL DEFAULT 0,
  `collected` DECIMAL(13, 2) NOT NULL DEFAULT 0,
